...
```{r}
# show residual plots
plot(simulateResiduals(model0), main = "Model 0: Null Model") # residuals for null model
plot(simulateResiduals(model1), main = "Model 1: Saturated Model") # residuals for saturated model
plot(simulateResiduals(model2), main = "Model 2: Season Predictor Only") # residuals for season predictor only model
plot(simulateResiduals(model3), main = "Model 3: Forest Distance Predictor Only") # residuals for forest distance only model
```
