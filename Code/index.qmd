...
Part 1: We observed a \[strong, weak\] \[positive, negative\] relationship (Pearson's r = **correlation coefficient**) between distance from headwaters (km) and annual total nitrogen load (kg/year) (F(**degrees of freedom**) = **F value**, p = 0.03, ⍺ = **significance level**).
